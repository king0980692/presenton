...
# Container DB (Lives inside the container or APP_DATA_DIRECTORY)
_container_db_path = os.environ.get("APP_DATA_DIRECTORY", "/app")
container_db_url = f"sqlite+aiosqlite:///{_container_db_path}/container.db"
